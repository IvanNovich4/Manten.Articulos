...
class Articulos:
    ...
    def abrir(self):
        conexion = psycopg2.connect(database="bd1", user="postgres", password="1234")
        return conexion
    ...
    def consulta(self, datos):
        ...
        cursor.execute(sql, datos)
        return cursor.fetchall() # Me devuelve todas las filas de la tabla articulos que coinciden con el codigo que le acabo de pasar.
